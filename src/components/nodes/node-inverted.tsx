...
// same as GraphNode except source and target sides are swapped
// this was done so that edge connections do not overlap with each other and look messy
export default function GraphNodeInverted(comp: NodeProps) {
  return (
    <div className="relative">
      <Handle type="target" position={Position.Left} />
      <div className="flex flex-col items-center">
        <div className="w-45 h-30 border-2 border-blue-600 bg-blue-50 rounded-md flex items-center justify-center">
        ...
        {comp.data.process_stream !== undefined && (
          <>
            ...
            >
              ...
              <UnicodeArrow color={comp.data.process_stream.color} direction="left" />
            </div>
            <div
